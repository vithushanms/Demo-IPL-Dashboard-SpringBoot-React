...
public class BatchConfiguration {
    ...
    private final String[] fieldNames = { "id", "city", "date", "player_of_match", "venue", "neutral_venue", "team1",
    ...
    public FlatFileItemReader<MatchInput> reader() {
        return new FlatFileItemReaderBuilder<MatchInput>().name("matchInputReader")
                .resource(new ClassPathResource("./IPL Matches 2008-2020.csv")).delimited().names(fieldNames)
